    ...
    <div className="privacy-page-container">
      ...
      <div className="privacy-body">
        ...
        <section className="policy-section">
          ...
          <p>이용자의 개인정보원은 원칙적으로 개인정보의 수집 및 이용 목적이 달성되면 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우(계약 철회 등 기록 5년, 대금결제 기록 5년 등)에는 해당 기간 동안 보관합니다.</p>
        </section>
        ...
        <div className="close-btn-wrap">
          <button onClick={() => window.close()} className="btn-close">창 닫기</button>
        </div>
      </div>
    </div>
  );
